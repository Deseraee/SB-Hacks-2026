        ...
        <div style={styles.columns}>
          ...
          <div style={styles.col}>
            ...
            <div style={styles.block}>
              ...
              <p style={styles.p}>
                ...
                you can always ask for help even when you are in doubdt. 
              </p>
              <p style={styles.p}>
          ...
          <div style={styles.col}>
            ...
            <h2 style={styles.colTitle}> 🤝 Not alone</h2>
              ...
              <p style={styles.p}>
                If you’re a UCSB student, the Women's Center is a supportive space that offers confidential guidance, advocacy, and educational programs focused on gender equity, well-bing and empowerment. 
              </p>
            </div>
          </div>
        </div>
    ...
    >
      Find a Helpline
            ...
            <div style={styles.contactItem}>
              ...
              <div style={styles.contactText}>UCSB Women’s Center <a
        href="https://womenscenter.sa.ucsb.edu/resources"
        target="_blank"
        rel="noopener noreferrer"
        style={styles.link}
        >View resources</a></div>
            </div>
          </div>
        </div>
      </div>
...
const styles = {
  page: {
    minHeight: "100vh",
    width: "100vw",
    background: "linear-gradient(135deg, #fff9e6 0%, #ffe8d6 50%, #ffd9e8 100%)", // soft gradient
