...
export default function Contact() {
  return (
    <div className="min-h-screen bg-[#FCF6BD] transition-all duration-1000 flex flex-col">
      ...
      <header className="bg-gradient-to-r from-orange-100 to-pink-100 shadow-md py-1.5 px-4">
    ...
    >
      ...
      {/* Main content with same width as other pages */}
        ...
        <div className="bg-white p-12 rounded-2xl shadow-lg">
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-4" style={{fontFamily: 'Mali'}}>
                Get in Touch
              </h2>
              <p className="text-xl text-gray-600 mb-8" style={{fontFamily: 'Mali'}}>
